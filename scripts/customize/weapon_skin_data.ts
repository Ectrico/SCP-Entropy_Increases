...
interface SkinData {
  ...
  permission: string; // 许可
  ascription: string; // 所属
}

export const HK_MP7_SkinList: SkinData[] = [
  {
    id: "hkmp7_miku16th",
    title: "§cMiku 16th 初音16周年",
    level: "§c[史诗]",
    icon_path: "textures/icons/weapons/hkmp7_miku16th.png",
    permission: "§aPublic",
    ascription: "§bFT-Official",
  },
];

export const M4A1_S_SkinList: SkinData[] = [
  {
    id: "m4a1s_printstream",
    title: "§cPrintStream 印花集",
    level: "§c[史诗]",
...
export const M4A1_SkinList: SkinData[] = [
  {
    id: "m4a1_gf_lunasia",
    title: "§a少女前线 Lunsia 露尼西亚",
    level: "§b[限定]",
...
export const AK103_SkinList: SkinData[] = [
  {
    id: "ak103_gf_spas12",
    title: "§1少女前线 SPAS-12",
    level: "§b[限定]",
