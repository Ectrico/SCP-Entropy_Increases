import { world, system, EquipmentSlot, BlockVolume, GameMode, } from "@minecraft/server";
...
export function HumanRaycast() {
    ...
    for (const player of AllPlayers) {
        ...
        for (let i = 0; i < RaysCount; i++) {
            ...
            const PlayerHitEntity = overworld.getEntitiesFromRay(player.getHeadLocation(), RotationDirection(ViewDirection, angle), RaycastOptions);
            // 遍历射线击中的实体
                ...
                if (!player.hasTag("scp")) {
                    for (const RaycastHit of PlayerHitEntity) {
                        ...
                        if (RaycastHit.entity.hasTag("scp966")) {
                            const HeadItemID = (_b = (_a = player.getComponent("minecraft:equippable")) === null || _a === void 0 ? void 0 : _a.getEquipment(EquipmentSlot.Head)) === null || _b === void 0 ? void 0 : _b.typeId;
    ...
    for (const player of AllPlayers) {
        if (player.hasTag("scp106")) {
            ...
            for (const Doorlocation of DoorResetRange) {
                ...
                const DoorState = Door === null || Door === void 0 ? void 0 : Door.permutation.getState("bl:door_geomrtry_states");
                if (DoorState === 0 && DoorState !== undefined) {
                    // 中心列
                    if (Doorlocation.x === CenterX && Doorlocation.z === CenterZ) {
                        try {
                            Door === null || Door === void 0 ? void 0 : Door.setPermutation(Door.permutation.withState("bl:door_geomrtry_states", 0));
                            Door === null || Door === void 0 ? void 0 : Door.setPermutation(Door.permutation.withState("bl:logical_sequence", "forward"));
                            Door === null || Door === void 0 ? void 0 : Door.setPermutation(Door.permutation.withState("bl:collision", false));
                        }
                        catch (_a) { }
                    }
                    // 非中心列
                        ...
                        try {
                            Door === null || Door === void 0 ? void 0 : Door.setPermutation(Door === null || Door === void 0 ? void 0 : Door.permutation.withState("bl:door_geomrtry_states", 0));
                            Door === null || Door === void 0 ? void 0 : Door.setPermutation(Door === null || Door === void 0 ? void 0 : Door.permutation.withState("bl:logical_sequence", "forward"));
                            Door === null || Door === void 0 ? void 0 : Door.setPermutation(Door === null || Door === void 0 ? void 0 : Door.permutation.withState("bl:collision", true));
                        }
                        catch (_b) { }
                    }
                }
...
// 特殊攻击事件监听
export let SpawnPointSCP049_2;
export let SCP049ChooseType;
export let SCP049_Infection;
export let SCP008_Infection;
//定义冷却循环体
let SCP049CoolDown;
world.afterEvents.entityHitEntity.subscribe((arg) => {
    ...
    if (DamagingEntity.hasTag("scp049")) {
        ...
        if (Touched !== undefined) {
            ...
            const TargetOffHandItem = (_a = SCP049_Infection.getComponent("equippable")) === null || _a === void 0 ? void 0 : _a.getEquipment(EquipmentSlot.Offhand);
            // world.sendMessage(`${TargetOffHandItem?.typeId}`);
            if ((TargetOffHandItem === null || TargetOffHandItem === void 0 ? void 0 : TargetOffHandItem.typeId) === "bli:scp714") {
                ...
                function Infections() {
                    ...
                    SCP049CoolDown = system.runInterval(() => {
                        ...
                        overworld.runCommand(`title "${DamagingEntity.name}" title §e"正在进行尸体手术...(${Math.floor(CoolTime / 20)}s)"\n§f正在将玩家§f转化为：§c${SCP049ChooseType.subtitle}`);
...
let Trigger = true;
let Attack096 = false;
let BreakDoorInterval;
let TriggerInterval;
export function SCP096ScreamAttack(player) {
    let ScreamTime = 10;
    let AttackTime = 20;
    PlaySoundForAllPlayer("Tir");
    overworld.runCommand(`replaceitem entity "${player.name}" slot.armor.head 0 icon:scp_096_crying 1 0 {"minecraft:item_lock":{"mode":"lock_in_slot"},"minecraft:keep_on_death":{}}`);
    function Scream() {
        if (ScreamTime > 0) {
            ScreamTime--;
            system.runTimeout(() => {
            ...
            overworld.runCommand(`replaceitem entity "${player.name}" slot.armor.head 0 icon:scp_096_attacking 1 0 {"minecraft:item_lock":{"mode":"lock_in_slot"},"minecraft:keep_on_death":{}}`);
        }
    }
    Scream();
    overworld.runCommand(`gamerule sendcommandfeedback false`);
    ...
    function Attack() {
        if (AttackTime > 0) {
            ...
            overworld.runCommand(`replaceitem entity "${player.name}" slot.armor.head 0 icon:scp_096_normal 1 0 {"minecraft:item_lock":{"mode":"lock_in_slot"},"minecraft:keep_on_death":{}}`);
    ...
    function BreakDoor() {
        ...
        for (const GetLocation of GetDoorRange) {
            ...
            const GetBlockPermutation = GetBlock === null || GetBlock === void 0 ? void 0 : GetBlock.permutation.getState("bl:door_geomrtry_states");
            const AgreeDoor = [
                "bl:light_door",
                "bl:light_door_upper",
                "bl:light_door_2",
            ...
            if (AgreeDoor.includes(GetBlock === null || GetBlock === void 0 ? void 0 : GetBlock.typeId)) {
                if (GetBlockPermutation === 0 && GetBlockPermutation !== undefined) {
                    const GeoState = GetBlock === null || GetBlock === void 0 ? void 0 : GetBlock.permutation.withState("bl:door_geomrtry_states", 14);
                    GetBlock === null || GetBlock === void 0 ? void 0 : GetBlock.setPermutation(GeoState);
                    const LSState = GetBlock === null || GetBlock === void 0 ? void 0 : GetBlock.permutation.withState("bl:logical_sequence", "reverse");
                    GetBlock === null || GetBlock === void 0 ? void 0 : GetBlock.setPermutation(LSState);
...
//# sourceMappingURL=character_skills.js.map